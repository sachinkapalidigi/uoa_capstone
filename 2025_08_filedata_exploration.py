...
enhanced = pd.read_csv("/content/drive/MyDrive/Capstone/MICoL_data/Test/enhancement.txt", delimiter="\t", header=None, names=['Pair', 'Doc1', 'Doc2'])
enhanced.describe(include='all')
